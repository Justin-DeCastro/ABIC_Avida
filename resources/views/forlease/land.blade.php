            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        <h2 class="text-secondary double-down-line text-center mb-5">FOR LEASE</h2></div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                <img src="{{ asset('images/lease/' . $lease->image) }}" alt="{{ $lease->name }}" class="img-fluid">
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="{{ route('viewlease', ['id' => $lease->id]) }}">{{ $lease->name }}</a></h5>

                        </p> <!-- Added Font Awesome icon for description -->
                                <p><i class="fas fa-dollar-sign"></i> Price: {{ $lease->price }}</p> <!-- Added Font Awesome icon for price -->
