        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#LeaseModal">
                                Lease Here
                            </button>
                        </div>
                        <div class="card-body">
...
<div class="modal fade" id="LeaseModal" tabindex="-1" role="dialog" aria-labelledby="addLeaseModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addLeaseModalLabel">Lease here</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="addLeaseForm" action="{{ route('lease.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<!-- Modal for Deleting lease -->
{{-- <div class="modal fade" id="deleteLeaseModal" tabindex="-1" role="dialog" aria-labelledby="deleteLeaseModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <form id="deleteLeaseForm" action="{{ route('lease.destroy', $lease->id) }}" method="POST">
