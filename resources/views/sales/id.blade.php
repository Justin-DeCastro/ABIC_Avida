                ...
                <section class="single-product">
                    <div class="container">
                        <div class="row justify-content-center">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <img src="{{ asset('images/sale/' . $sale->image) }}" alt="">
                                    </div>
                                    <div class="col-md-7">
                                        ...
                                        <div class="single-product-description">
                                            <p class="details">{{ $sale->description }}</p>
                                            <h6 class="price">&#8369;{{ $sale->price }}</h6>
                                        </div>
                                        <hr>
                                        <div class="amenities">
                                            <ul>
                                                <li>{{ $sale->amenities }}</li>

                                            </ul>
                                        </div>
                                        <div class="contact">
                                        <i class="fa-solid fa-phone"></i> {{ $sale->contact }}
                                        </div>
                                    </div>
                                </div>
