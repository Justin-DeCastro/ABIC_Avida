    ...
    <div id="main">
        <div class="our-properties">
            ...
            <div class="how-section1">
                <div class="row">
                    <div class="col-md-6 how-img" style="background-image: url('{{ asset('images/sale/' . $sale->image) }}'); background-position: center; background-size: cover; position: relative; height: 500px;">
                    </div>
                    <div class="col-md-6">
                        <h4 style="font-size: 24px;">Building Name: {{ $sale->name }}</h4>
                        <h4 class="subheading"></h4>
                        <p class="text-muted" style="font-size: 36px;">{{ $sale->description }}</p>
                        <h4 style="font-size: 24px;">Price: {{ $sale->price }}</h4>
                        <h4 style="font-size: 24px;" class="fas fa-bed"> Amenities: {{ $sale->amenities }}</h4>
                        <h4 style="font-size: 24px;" class="fas fa-phone"> Contact: {{ $sale->contact }}</h4>
                    </div>
                </div>
            </div>
