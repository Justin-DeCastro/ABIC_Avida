                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteForm{{ $contact->id }}" action="{{ route('contacts.destroy', $contact->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button id="deleteButton{{ $contact->id }}" type="submit" class="btn btn-warning" onclick="disableButton('deleteButton{{ $contact->id }}')">
                                                        <i class="fas fa-trash"></i> <!-- Font Awesome times icon -->
                                                    </button>
                                                </form>
