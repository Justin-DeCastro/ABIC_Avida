                        ...
                        <div id="indicators" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active"
                                    style="background-image: url('https://images.unsplash.com/32/Mc8kW4x9Q3aRR3RkP5Im_IMG_4417.jpg?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80')">
                                ...
                                <div class="carousel-item"
                                    style="background-image: url('https://images.unsplash.com/photo-1460602594182-8568137446ce?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1355&q=80')">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item"
                                    style="background-image: url('https://images.unsplash.com/photo-1465146633011-14f8e0781093?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80')">
                                    <div class="carousel-caption d-none d-md-block">
        ...
        <div class="footer-section-content" data-testid="footer-section-content">
            ...
            <div class="footer-avida-container">
                <div><img class="footer-avida-icon"
                    ...
                    <div class="footer-social-container"><a href="https://www.facebook.com/tine.tainy" target="_blank"
                            rel="noopener noreferrer"><img class="footer-social-facebook"
                                ...
                                alt="fbIcon"></a><a href="https://www.instagram.com/jmdec21" target="_blank"
                            rel="noopener noreferrer"><img class="footer-social-instagram"
                                ...
                                alt="instaIcon"></a><a href="https://www.youtube.com/channel/UCPwJEq3kPoAzqYezSzC4TyA"
            ...
            <div class="footer-details-container">
                <div class="hotline-container">
                    ...
                    <div>
                        ...
                        <p class="hotline-container-numbers">0945-675-4591</p>
                    </div>
                    <div>
                        <p class="hotline-container-details">Head Office Trunk line:</p>
                        <p class="hotline-container-numbers">0948-387-7158</p>
                    </div>
                ...
                <div class="footer-navlinks">
                    ...
                    <div class="footer-link">
                        <div class="footer-link-container">
                            <div class="footer-link-group">
                                <div><a href="https://www.facebook.com/tine.tainy">Facebook</a></div>
                                <div><a href="/neighborhoods/">Neighborhoods</a></div>
                                <div><a href="/buyers-guide/">Buyer's Guide</a></div>
                                <div><a href="/news-and-events/">News &amp; Events</a></div>
                            </div>
                    ...
                    <div class="footer-navlinks-container">
                        <div class="footer-group">
                            <div><a href="https://www.facebook.com/tine.tainy">Facebook</a></div>
                            <div><a href="https://www.instagram.com/jmdec21">Instagram</a></div>
                            <div><a href="https://web.telegram.org/">Telegram</a></div>
                            <div><a href="mailto:decastrojustin24@gmail.com">Email</a></div>
